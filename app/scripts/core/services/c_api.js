...
angular.module('ngApp')
  .factory('c_api', function($resource, appCfg, CacheFactory, $window) {
      ...
      message: {
        ...
        set: function(d) {
          ...
          try {
            ...
            this.data.type = d.status >= 400 ? 'danger' : d.type || 'success';
            this.data.timeout = d.type === 'danger' ? '5000' : '3000';
            this.data.class = d.type === 'danger' ? 'apiMessageAttn' : 'apiMessage';
          } catch (e) {
            this.data.msg = 'Error';
            this.data.desc = '';
            ...
            $window.JL().fatalException('unhandled api repsonse error', e);
          }
          this.show = true;
        }
      }
